...
import 'package:tictact/custom_dialog.dart';
import 'package:tictact/game_button.dart';
        ...
        setState(() {
         ...
         int winner =checkWinner();
          if(winner == -1){
            ...
            showDialog(
            context: context,
            builder: (_) => new CustomDialog("Equals", "Press the reset button to start again", resetGame)
          );
        }
          }else{
            checkWinner();
